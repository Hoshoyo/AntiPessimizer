...
{$Z1}
  ...
  UdRec = record
    ...
    inpCurr : Byte;
    inpCtr  : Uint64;
    inpSess : array [0..64-1] of Byte;
    inpEnd  : Integer;
    inpPeek : Integer;

    translator  : Pointer; // void (*translator)(struct ud*);
    insnOffset  : Uint64;
    insnHexcode : array [0..64-1] of Byte;

    asmBuf      : PByte;
    asmBufSize  : UInt64;
    asmBufFill  : UInt64;
    asmBufInt   : array [0..128-1] of Byte;

    symResolver : Pointer; // const char* (*sym_resolver)(struct ud*, uint64_t addr, int64_t *offset);
    ...
    udOperand : array [0..4-1] of TUdOperand;
    nError   : Byte;
    pfxRex   : Byte;
    pfxSeg   : Byte;
    pfxOpr   : Byte;
...
var
  ...
  UdInSnAsm        : function  (ud : PUdRec): PAnsiChar; stdcall;
